...
class CLIPVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.FloatTensor) -> torch.Tensor:
        ...
        embeddings = embeddings + self.position_embedding(self.position_ids) # attach [CLS] embedding: [1, 576 + 1, 1024]
        return embeddings
...
class CLIPSdpaAttention(CLIPAttention):
    ...
    def forward(
        ...
        bsz, tgt_len, embed_dim = hidden_states.size() # [1, 576 + 1, 1024]
...
class CLIPEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        if output_attentions:
            outputs += (attn_weights,) # [bsz, heads, patch_len, patch_len]
...
class CLIPEncoder(nn.Module):
    ...
    def forward(
        ...
        for idx, encoder_layer in enumerate(self.layers): # 24
...
class CLIPVisionTransformer(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.embeddings(pixel_values) # [1, 576 + 1 (attached here), 1024]
